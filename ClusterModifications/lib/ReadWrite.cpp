...
void WriteSingleWorkData(string WriteName, double ProtocolDuration, double WorkVal){

	std::ofstream WriteFile;

	WriteFile.open(WriteName);

	WriteFile << std::to_string(ProtocolDuration) << "\t" << std::to_string(WorkVal) << "\n";
